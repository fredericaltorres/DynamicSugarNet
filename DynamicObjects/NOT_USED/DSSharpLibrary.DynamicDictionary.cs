...
namespace DynamicSugarSharp {
    ...
    /// </summary>
    public class DynamicDictionaryException : System.Exception {

        public DynamicDictionaryException(string message) : base(message) { }
    }
    /// <summary>
    ...
    public class DynamicDictionary : DynamicObject, IDictionary<string, object> {
        ...
        public static dynamic Create(object anonymousInstance){
            ...
            return new DynamicDictionary().MoreValues(anonymousInstance);
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <returns></returns>
        public DynamicDictionary MoreValues(object value) {
        ...
        private void SetDictionaryFromParameters(CallInfo callInfo, object [] args) {
            ...
            for (int i = 0; i < args.Length; i++) {
                if (callInfo.ArgumentCount > 0)
                    this._dictionary.Add(callInfo.ArgumentNames [i], args [i]);
            }
        }
